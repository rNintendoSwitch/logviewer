...
class LogEntry:
    ...
    def render_plain_text(self):
        ...
        if not self.open and self.recipient.id:
...
class User:
    def __init__(self, data):
        ...
        self.discriminator = data["discriminator"] if "discriminator" in data else 0
        self.avatar_url = data["avatar_url"] if "avatar_url" in data else None
        self.mod = data["mod"] if "mod" in data else None
